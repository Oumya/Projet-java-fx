...
public class RendezVous {
   ...
   private int prestationId;
    ...
    public RendezVous(int id, java.sql.Date date, int patientNci, String etat, int specialiteId, int prestationId) {
        this.id = id;
        this.date = date;
    ...
    public RendezVous(java.sql.Date date, int patientNci, String etat, int specialiteId, int prestationId) {
        this.date = date;
        this.patientNci = patientNci;
        this.etat = etat;
        this.specialiteId = specialiteId;
